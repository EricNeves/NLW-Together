...
var CreateUserController = /** @class */ (function () {
    ...
    CreateUserController.prototype.handle = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name_1, email, admin, password, createUserService, user, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = request.body, name_1 = _a.name, email = _a.email, admin = _a.admin, password = _a.password;
                        createUserService = new CreateUserService_1.CreateUserService();
                        return [4 /*yield*/, createUserService.execute({
                                name: name_1, email: email, admin: admin, password: password
                            })];
                    case 1:
                        user = _b.sent();

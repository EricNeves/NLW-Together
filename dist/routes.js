...
var ListUserByIdController_1 = require("./controllers/ListUserByIdController");
var ListTagByIdController_1 = require("./controllers/ListTagByIdController");
...
var listUserByIdController = new ListUserByIdController_1.ListUserByIdController();
var listTagByIdController = new ListTagByIdController_1.ListTagByIdController();
...
router.get('/users/:id', ensureAuthenticated_1.ensureAuthenticated, listUserByIdController.handle);
router.get('/tags/:id', ensureAuthenticated_1.ensureAuthenticated, listTagByIdController.handle);
router.delete('/tag', ensureAuthenticated_1.ensureAuthenticated, ensureAdmin_1.ensureAdmin, deleteTagController.handle);
router.delete('/compliment', ensureAuthenticated_1.ensureAuthenticated, deleteSendComplimentController.handle);
